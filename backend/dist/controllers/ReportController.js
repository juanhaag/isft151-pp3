    ...
    constructor() {
        this.generateReport = async (req, res) => {
            try {
                ...
                if (aiProvider && !Object.values(AIProviderFactory_1.AIProviderType).includes(aiProvider)) {
                    res.status(400).json({
                        success: false,
                        error: `Invalid AI provider. Available options: ${Object.values(AIProviderFactory_1.AIProviderType).join(', ')}`
                    });
                    return;
                }
                ...
                if (aiProvider && aiProvider !== AIProviderFactory_1.AIProviderType.GEMINI) {
                    try {
                ...
                const request = {
                    spotId,
                    userPreferences,
                    aiProvider: aiProvider || AIProviderFactory_1.AIProviderType.GEMINI,
        ...
        this.getReportsBySpot = async (req, res) => {
            try {
        ...
        this.getRecentReports = async (req, res) => {
            try {
        ...
        this.getReportsByZone = async (req, res) => {
            try {
        ...
        this.searchReports = async (req, res) => {
            try {
                const { q } = req.query;
                const limit = parseInt(req.query.limit) || 20;
        ...
        this.getReportStats = async (req, res) => {
            try {
        ...
        this.getReportsWithGoodConditions = async (req, res) => {
            try {
                const minWaveHeight = parseFloat(req.query.minWaveHeight) || 1.0;
        ...
        this.getWeatherForecast = async (req, res) => {
            try {
                const { spotId } = req.params;
        ...
        this.testServices = async (req, res) => {
            try {
