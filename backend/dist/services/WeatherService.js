...
class WeatherService {
    async getWeatherData(location, forecastDays = 7) {
        try {
    ...
    async getMarineData(location, forecastDays) {
    ...
    async getMeteoData(location, forecastDays) {
    ...
    mergeWeatherData(marineData, meteoData) {
...
WeatherService.MARINE_BASE_URL = 'https://marine-api.open-meteo.com/v1/marine';
WeatherService.METEO_BASE_URL = 'https://api.open-meteo.com/v1/forecast';
